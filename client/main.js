...
document.getElementById('btnSolidFill').addEventListener('click', function() { csInterface.evalScript('buatSolidFill("' + getRasio() + '")'); });
...
document.getElementById('btnAdjComp').addEventListener('click', function() { csInterface.evalScript('buatAdjComp()'); });
...
document.getElementById('pilihStagger').addEventListener('change', function() {
    ...
    if (this.value === 'end') { btnCut.style.display = 'none'; } 
    else { btnCut.style.display = 'block'; }
});
...
document.getElementById('btnUnComp').addEventListener('click', function() {
